...
package eu.europa.ec.eudi.verifier.core.logging

import androidx.annotation.IntDef
import eu.europa.ec.eudi.verifier.core.EudiVerifierConfig
import eu.europa.ec.eudi.verifier.core.logging.Logger.Companion.LEVEL_DEBUG
import eu.europa.ec.eudi.verifier.core.logging.Logger.Companion.LEVEL_ERROR
import eu.europa.ec.eudi.verifier.core.logging.Logger.Companion.LEVEL_INFO
import eu.europa.ec.eudi.verifier.core.logging.Logger.Companion.OFF
...
fun interface Logger {
    ...
    companion object {
        ...
        /**
         * Construct a default instance of [Logger] with the provided [EudiVerifierConfig]
         */
        operator fun invoke(config: EudiVerifierConfig): Logger =
            LoggerImpl(config.logLevel, config.logSizeLimit)
    }

    /**
     * Log level annotation for configuring logging with [EudiVerifierConfig.configureLogging]
     */
